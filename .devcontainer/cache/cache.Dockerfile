...
# Other image contents: https://github.comUnity-Billal-mesloub/vscode-dev-containers/blob/main/repository-containers/images/github.com/microsoft/vscode/.devcontainer/base.Dockerfile

# This first stage generates cache.tar
FROM mcr.microsoft.com/vscode/devcontainers/repos/Unity-Billal-mesloub/vscode:dev as cache
ARG USERNAME=node
...
FROM mcr.microsoft.com/vscode/devcontainers/repos/Unity-Billal-mesloub/vscode:dev as dev-container
ARG USERNAME=node
ARG CACHE_FOLDER="/home/${USERNAME}/.devcontainer-cache"
